...
function FormAddIzinMobile(props) {
  ...
  return (
    <div>
      <div
        className={`p-6 duration-500 flex w-full flex-col justify-between items-start px-2 bg-white rounded-xl shadow-md `}
      >
        <div
        ...
        >
          ...
          <div className="w-[100%] gap-2 flex  justify-between items-center gap-4 ">
            <div className="w-[100%] gap-2 flex flex-col justify-start items-start p-2 gap-4 ">
          ...
          <div className="w-[100%] gap-2 flex  justify-between items-center gap-4 ">
            <div className="w-[100%] gap-2 flex flex-col justify-start items-start p-2 gap-4 z-[991] ">
              ...
              <Select
                ...
                inputId="input"
                className="w-full p-1 border border-blue-600 rounded-xl z-[991]"
                value={jenisIzin}
          ...
          <div className="w-[100%] gap-2 flex  justify-between items-center ">
            <div className="w-[100%] gap-2 flex flex-col justify-start items-start p-2 gap-4 ">
              ...
              <div className="w-[100%] flex z-[99] bg-white justify-start gap-3 items-center  rounded-xl">
                <TimePicker
                  ...
                  className="bg-white border w-[100%] rounded-xl border-blue-500  p-3 hover:text-blue-800 active:text-blue-800"
                />
              </div>
            </div>
            <div className="w-[100%] gap-2 flex flex-col justify-start items-start p-2 gap-4 ">
        ...
        <div className="w-full flex justify-center">
          {" "}
          <button
            class="flex justify-center text-base w-[18rem] hover:bg-white border duration-150 hover:border-blue-500 hover:text-blue-600 items-center p-3 px-10 ml-4 bg-blue-600 text-white font-medium rounded-xl gap-4"
            onClick={handleAdd}
          >
            Ajukan
...
export default FormAddIzinMobile;
